        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <div>
              ...
              <input
  type="text"
  className="w-full border-2 border-gray-200 bg-white text-gray-900 placeholder:text-gray-400
  focus:border-purple-500 focus:ring-4 focus:ring-purple-100
  dark:bg-gray-900 dark:text-gray-100 dark:placeholder:text-gray-500 dark:border-gray-700
  p-3 rounded-xl transition-all duration-300 outline-none"
...
/>
  ...
  focus:border-purple-500 focus:ring-4 focus:ring-purple-100
  dark:bg-gray-900 dark:text-gray-100 dark:placeholder:text-gray-500 dark:border-gray-700
  p-3 rounded-xl transition-all duration-300 outline-none resize-none"
